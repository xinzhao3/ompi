...
OPAL_DECLSPEC int
opal_common_ucx_mem_op(opal_common_ucx_mem_t *mem,
...
static int _tlocal_mem_create_rkey(_tlocal_mem_t *mem_rec, ucp_ep_h ep,
                                   int target);
...
static int
_common_ucx_ctx_append(opal_common_ucx_ctx_t *ctx,
