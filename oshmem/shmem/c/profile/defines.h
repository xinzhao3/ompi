...
#define shmem_ctx_int_atomic_cswap   pshmem_ctx_int_atomic_cswap
#define shmem_ctx_long_atomic_cswap  pshmem_ctx_long_atomic_cswap
#define shmem_ctx_longlong_atomic_cswap pshmem_ctx_longlong_atomic_cswap
#define shmem_int_atomic_cswap       pshmem_int_atomic_cswap
#define shmem_long_atomic_cswap      pshmem_long_atomic_cswap
#define shmem_longlong_atomic_cswap  pshmem_longlong_atomic_cswap
...
/* Atomic Fetch&Add */
#define shmem_ctx_int_atomic_fadd    pshmem_ctx_int_atomic_fadd
#define shmem_ctx_long_atomic_fadd   pshmem_ctx_long_atomic_fadd
#define shmem_ctx_longlong_atomic_fadd pshmem_ctx_longlong_atomic_fadd
...
/* Atomic Fetch&Inc */
#define shmem_ctx_int_atomic_finc    pshmem_ctx_int_atomic_finc
#define shmem_ctx_long_atomic_finc   pshmem_ctx_long_atomic_finc
#define shmem_ctx_longlong_atomic_finc pshmem_ctx_longlong_atomic_finc
#define shmem_int_atomic_finc        pshmem_int_atomic_finc
#define shmem_long_atomic_finc       pshmem_long_atomic_finc
#define shmem_longlong_atomic_finc   pshmem_longlong_atomic_finc
