...
#if OSHMEM_HAVE_C11
#define pshmem_p(ctx, dst, val, pe)                           \
    _Generic(&*(dst),                                         \
            ...
            long double*: pshmem_ctx_longdouble_p)(ctx, dst, val, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_put(ctx, dst, src, len, pe)         \
    _Generic(&*(dst),                              \
            ...
            long double*: pshmem_ctx_longdouble_put)(ctx, dst, src, len, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_iput(ctx, dst, src, tst, sst, len, pe) \
    _Generic(&*(dst),                                \
            ...
            long double*: pshmem_ctx_longdouble_iput)(ctx, dst, src, tst, sst, len, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_put_nbi(ctx, dst, src, len, pe)          \
    _Generic(&*(dst),                                   \
            ...
            long double*: pshmem_ctx_longdouble_put_nbi)(ctx, dst, src, len, pe)
#endif
...
#define pshmem_g(ctx, addr, pe)                               \
    _Generic(&*(addr),                                        \
            ...
            long double*: pshmem_ctx_longdouble_g)(ctx, addr, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_get(ctx, dst, src, len, pe)          \
    _Generic(&*(dst),                               \
            ...
            long double*: pshmem_ctx_longdouble_get)(ctx, dst, src, len, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_iget(ctx, dst, src, tst, sst, len, pe) \
    _Generic(&*(dst),                                \
            ...
            long double*: pshmem_ctx_longdouble_iget)(ctx, dst, src, tst, sst, len, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_get_nbi(ctx, dst, src, len, pe)          \
    _Generic(&*(dst),                                   \
            ...
            long double*: pshmem_ctx_longdouble_get_nbi)(ctx, dst, src, len, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_swap(ctx, dst, val, pe)                 \
    _Generic(&*(dst),                                         \
            ...
            double*:      pshmem_ctx_double_atomic_swap)(ctx, dst, val, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_swap(dst, val, pe)                      \
    _Generic(&*(dst),                                         \
            ...
            double*:      pshmem_double_atomic_swap)(dst, val, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_set(ctx, dst, val, pe)                 \
    _Generic(&*(dst),                                        \
            ...
            double*:      pshmem_ctx_double_atomic_set)(ctx, dst, val, pe)
#endif
...
OSHMEM_DECLSPEC int pshmem_ctx_int_atomic_cswap(shmem_ctx_t ctx, int *target, int cond, int value, int pe);
OSHMEM_DECLSPEC long pshmem_ctx_long_atomic_cswap(shmem_ctx_t ctx, long *target, long cond, long value, int pe);
OSHMEM_DECLSPEC long long pshmem_ctx_longlong_atomic_cswap(shmem_ctx_t ctx, long long *target, long long cond, long long value, int pe);

#if OSHMEM_HAVE_C11
#define pshmem_atomic_cswap(ctx, dst, cond, val, pe)           \
    _Generic(&*(dst),                                          \
            int*:         pshmem_ctx_int_atomic_cswap,         \
            long*:        pshmem_ctx_long_atomic_cswap,        \
            long long*:   pshmem_ctx_longlong_atomic_cswap)(ctx, dst, cond, val, pe)
#endif

OSHMEM_DECLSPEC int pshmem_int_atomic_cswap(int *target, int cond, int value, int pe);
OSHMEM_DECLSPEC long pshmem_long_atomic_cswap(long *target, long cond, long value, int pe);
OSHMEM_DECLSPEC long long pshmem_longlong_atomic_cswap(long long *target, long long cond, long long value, int pe);

#if OSHMEM_HAVE_C11
#define pshmem_atomic_cswap(dst, cond, val, pe)                \
    _Generic(&*(dst),                                          \
            int*:         pshmem_int_atomic_cswap,             \
            long*:        pshmem_long_atomic_cswap,            \
            long long*:   pshmem_longlong_atomic_cswap)(dst, cond, val, pe)
#endif
...
/* Atomic Fetch&Add */
OSHMEM_DECLSPEC int pshmem_ctx_int_atomic_fadd(shmem_ctx_t ctx, int *target, int value, int pe);
OSHMEM_DECLSPEC long pshmem_ctx_long_atomic_fadd(shmem_ctx_t ctx, long *target, long value, int pe);
OSHMEM_DECLSPEC long long pshmem_ctx_longlong_atomic_fadd(shmem_ctx_t ctx, long long *target, long long value, int pe);
#if OSHMEM_HAVE_C11
#define pshmem_atomic_fadd(ctx, dst, val, pe)                 \
    _Generic(&*(dst),                                         \
            int*:         pshmem_ctx_int_atomic_fadd,         \
            long*:        pshmem_ctx_long_atomic_fadd,        \
            long long*:   pshmem_ctx_longlong_atomic_fadd)(ctx, dst, val, pe)
#endif

OSHMEM_DECLSPEC int pshmem_int_atomic_fadd(int *target, int value, int pe);
OSHMEM_DECLSPEC long pshmem_long_atomic_fadd(long *target, long value, int pe);
OSHMEM_DECLSPEC long long pshmem_longlong_atomic_fadd(long long *target, long long value, int pe);
#if OSHMEM_HAVE_C11
#define pshmem_atomic_fadd(dst, val, pe)                      \
    _Generic(&*(dst),                                         \
            int*:         pshmem_int_atomic_fadd,             \
            long*:        pshmem_long_atomic_fadd,            \
            long long*:   pshmem_longlong_atomic_fadd)(dst, val, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_fetch(ctx, dst, pe)                 \
    _Generic(&*(dst),                                     \
            ...
            double*:      pshmem_ctx_double_atomic_fetch)(ctx, dst, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_fetch(dst, pe)                      \
    _Generic(&*(dst),                                     \
            ...
            double*:      pshmem_double_atomic_fetch)(dst, pe)
#endif
...
/* Atomic Fetch&Inc */
OSHMEM_DECLSPEC int pshmem_ctx_int_atomic_finc(shmem_ctx_t ctx, int *target, int pe);
OSHMEM_DECLSPEC long pshmem_ctx_long_atomic_finc(shmem_ctx_t ctx, long *target, int pe);
OSHMEM_DECLSPEC long long pshmem_ctx_longlong_atomic_finc(shmem_ctx_t ctx, long long *target, int pe);
#if OSHMEM_HAVE_C11
#define pshmem_atomic_finc(ctx, dst, pe)                \
    _Generic(&*(dst),                                   \
            int*:         pshmem_ctx_int_atomic_finc,   \
            long*:        pshmem_ctx_long_atomic_finc,  \
            long long*:   pshmem_ctx_longlong_atomic_finc)(ctx, dst, pe)
#endif

OSHMEM_DECLSPEC int pshmem_int_atomic_finc(int *target, int pe);
OSHMEM_DECLSPEC long pshmem_long_atomic_finc(long *target, int pe);
OSHMEM_DECLSPEC long long pshmem_longlong_atomic_finc(long long *target, int pe);
#if OSHMEM_HAVE_C11
#define pshmem_atomic_finc(dst, pe)                     \
    _Generic(&*(dst),                                   \
            int*:         pshmem_int_atomic_finc,       \
            long*:        pshmem_long_atomic_finc,      \
            long long*:   pshmem_longlong_atomic_finc)(dst, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_add(ctx, dst, val, pe)                 \
    _Generic(&*(dst),                                        \
            int*:         pshmem_ctx_int_atomic_add,         \
            long*:        pshmem_ctx_long_atomic_add,        \
            long long*:   pshmem_ctx_longlong_atomic_add)(ctx, dst, val, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_add(dst, val, pe)                      \
    _Generic(&*(dst),                                        \
            int*:         pshmem_int_atomic_add,             \
            long*:        pshmem_long_atomic_add,            \
            long long*:   pshmem_longlong_atomic_add)(dst, val, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_inc(ctx, dst, pe)                \
    _Generic(&*(dst),                                  \
            int*:         pshmem_ctx_int_atomic_inc,   \
            long*:        pshmem_ctx_long_atomic_inc,  \
            long long*:   pshmem_ctx_longlong_atomic_inc)(ctx, dst, pe)
#endif
...
#if OSHMEM_HAVE_C11
#define pshmem_atomic_inc(dst, pe)                     \
    _Generic(&*(dst),                                  \
            int*:         pshmem_int_atomic_inc,       \
            long*:        pshmem_long_atomic_inc,      \
            long long*:   pshmem_longlong_atomic_inc)(dst, pe)
#endif
