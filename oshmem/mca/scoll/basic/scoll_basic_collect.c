                                         ...
                                         long *pSync)
{
    ...
    if (PE_root == group->my_pe) {
        ...
        for (i = 0; (i < group->proc_count) && (rc == OSHMEM_SUCCESS); i++) {
            ...
            rc = MCA_SPML_CALL(get(SHMEM_CTX_DEFAULT, (void *)source, nlong, (void*)((unsigned char*)target + i * nlong), pe_cur));
        }
    }
                                    ...
                                    long *pSync)
{
    ...
    while (exit_flag && (rc == OSHMEM_SUCCESS)) {
       ...
       */
            do {
                MCA_SPML_CALL(get(SHMEM_CTX_DEFAULT, (void*)pSync, sizeof(value), (void*)&value, peer_pe));
            } while (value != my_id);

            SCOLL_VERBOSE(14,
                          "[#%d] round = %d send data to #%d",
                          group->my_pe, round, peer_pe);
            rc = MCA_SPML_CALL(put(SHMEM_CTX_DEFAULT, (void*)((unsigned char*)target + my_id * nlong), (1 << (round - 1)) * nlong, (void*)((unsigned char*)target + my_id * nlong), peer_pe));

            MCA_SPML_CALL(fence(SHMEM_CTX_DEFAULT));

            SCOLL_VERBOSE(14,
                          "[#%d] round = %d signals to #%d",
                          group->my_pe, round, peer_pe);
            value = peer_id;
            rc = MCA_SPML_CALL(put(SHMEM_CTX_DEFAULT, (void*)pSync, sizeof(value), (void*)&value, peer_pe));
#endif
            SCOLL_VERBOSE(14, "[#%d] round = %d wait", group->my_pe, round);
                              ...
                              long *pSync)
{
    ...
    for (i = 0; (i < (group->proc_count - 1)) && (rc == OSHMEM_SUCCESS); i++) {
        ...
        rc = MCA_SPML_CALL(put(SHMEM_CTX_DEFAULT, (void*)((unsigned char*)target + data_index * nlong), nlong, (void*)((unsigned char*)target + data_index * nlong), peer_pe));
    ...
    if (my_id >= floor2_proc) {
        ...
        for (i = 0; (i < group->proc_count) && (rc == OSHMEM_SUCCESS); i++) {
            ...
            SCOLL_VERBOSE(14,
                          ...
                          group->my_pe, pe_cur);
            rc = MCA_SPML_CALL(put(SHMEM_CTX_DEFAULT, (void*)((unsigned char*)target + data_index * nlong), nlong, (void *)source, pe_cur));
        }
       ...
       */
            ...
            rc = MCA_SPML_CALL(put(SHMEM_CTX_DEFAULT, (void*)((unsigned char*)target + data_index * nlong), (1 << (round - 1)) * nlong, (void*)((unsigned char*)target + data_index * nlong), peer_pe));
        ...
        if ((group->proc_count - floor2_proc) > my_id) {
            ...
            SCOLL_VERBOSE(14,
                          "[#%d] is extra send data to #%d",
                          group->my_pe, peer_pe);
            rc = MCA_SPML_CALL(put(SHMEM_CTX_DEFAULT, target, group->proc_count * nlong, target, peer_pe));
    ...
    if (PE_root == group->my_pe) {
        ...
        if (wait_pe_array) {
            ...
            while (wait_pe_count) {
                ...
                for (i = 1; (i < group->proc_count) && (rc == OSHMEM_SUCCESS);
                    ...
                    if (wait_pe_array[i] == 0) {
                        pe_cur = oshmem_proc_pe(group->proc_array[i]);
                        value = 0;
                        rc = MCA_SPML_CALL(get(SHMEM_CTX_DEFAULT, (void*)pSync, sizeof(value), (void*)&value, pe_cur));
                        if ((rc == OSHMEM_SUCCESS)
                                && (value != _SHMEM_SYNC_VALUE)) {
            ...
            for (i = 1; (i < group->proc_count) && (rc == OSHMEM_SUCCESS);
                ...
                /* Get data from the current peer */
                rc = MCA_SPML_CALL(get(SHMEM_CTX_DEFAULT, (void *)source, (size_t)wait_pe_array[i], (void*)((unsigned char*)target + offset), pe_cur));
